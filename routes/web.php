...
Route::middleware(['auth'])->group(function () {
    ...
    // HR Admin Routes (HR and Super Admin)
    Route::middleware(['role:super_admin,hr'])->prefix('admin')->name('admin.')->group(function () {
        Route::get('/departments', [EnhancedAdminController::class, 'departments'])->name('admin.departments');
        Route::get('/departments/create', [EnhancedAdminController::class, 'createDepartment'])->name('admin.departments.create');
        Route::post('/departments', [EnhancedAdminController::class, 'storeDepartment'])->name('admin.departments.store');
        Route::get('/departments/{department}/edit', [EnhancedAdminController::class, 'editDepartment'])->name('admin.departments.edit');
        Route::put('/departments/{department}', [EnhancedAdminController::class, 'updateDepartment'])->name('admin.departments.update');
        Route::delete('/departments/{department}', [EnhancedAdminController::class, 'deleteDepartment'])->name('admin.departments.delete');
        Route::get('/reports', [EnhancedAdminController::class, 'reports'])->name('admin.reports');
        Route::post('/export/reports', [EnhancedAdminController::class, 'exportReports'])->name('admin.export.reports');
        Route::post('/export/audit-logs', [EnhancedAdminController::class, 'exportAuditLogs'])->name('export.audit-logs');
        
        // Settings
        Route::get('/settings', [EnhancedAdminController::class, 'settings'])->name('admin.settings');
        Route::put('/settings', [EnhancedAdminController::class, 'updateSettings'])->name('admin.settings.update');
        Route::post('/clear-cache', [EnhancedAdminController::class, 'clearCache'])->name('admin.clear-cache');
        Route::post('/optimize-database', [EnhancedAdminController::class, 'optimizeDatabase'])->name('admin.optimize-database');
    });

    // Employee and Head of Department Routes
    Route::middleware(['role:employee,head_of_department'])->group(function () {
    ...
    // Enhanced Leave Applications (accessible by all authenticated users)
    ...
    Route::middleware(['role:super_admin,admin,hr,head_of_department'])->group(function () {
...
Route::middleware(['auth', 'role:head_of_department'])->group(function () {
