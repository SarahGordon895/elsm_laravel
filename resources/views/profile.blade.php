        ...
        <div x-show="activeTab === 'employment'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
            <div class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900">{{ ucfirst($user->role) }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900">{{ $user->hire_date?->format('M d, Y') }}</p>
                        </div>
                        <div>
                ...
                <div class="bg-blue-50 rounded-lg p-6">
                    ...
                    @php
                        $leaveBalances = $user->leaveBalances()->with('leaveType')->whereHas('leaveType', function($query) {
                            $query->where('paid', true); // Only show paid leave types
                        })->get();
                    @endphp
