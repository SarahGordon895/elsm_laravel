...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 flex items-center justify-center py-4 sm:py-8 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-sm sm:max-w-md">
        ...
        <div class="text-center mb-6 sm:mb-8 lg:mb-12">
            ...
            <p class="text-sm sm:text-base text-gray-600">HR, HOD, Admin & Super Admin Access</p>
        </div>
        ...
        <div class="bg-white shadow-xl rounded-2xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            <div class="text-center mb-4 sm:mb-6 lg:mb-8">
                ...
                <p class="text-xs sm:text-sm text-gray-600">Enter your admin credentials</p>
            </div>

            <form class="space-y-3 sm:space-y-4 lg:space-y-6" method="POST" action="{{ route('login') }}" x-data="{ 
                loading: false,
                validateForm() {
                ...
                <div class="space-y-3 sm:space-y-4">
                    <div>
                        <label for="admin_email" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="admin_email" name="email" type="email" autocomplete="email" required 
                                   class="appearance-none relative block w-full pl-8 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-xs sm:text-sm lg:text-base transition-all duration-200" 
                    ...
                    <div>
                        <label for="admin_password" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="admin_password" name="password" type="password" autocomplete="current-password" required 
                                   class="appearance-none relative block w-full pl-8 sm:pl-10 pr-10 sm:pr-12 py-2 sm:py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-xs sm:text-sm lg:text-base transition-all duration-200" 
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
                    <div class="flex items-center">
                        <input id="admin_remember" name="remember" type="checkbox" 
                               class="h-3 w-3 sm:h-4 sm:w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded">
                        <label for="admin_remember" class="ml-2 block text-xs sm:text-sm text-gray-900">
                            Remember me
                        </label>
                    </div>
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-xs sm:text-sm text-purple-600 hover:text-purple-500 transition-colors duration-200">
                            Forgot password?
                        </a>
                    @endif
                </div>
                ...
                <div class="pt-2 sm:pt-4">
                    <button type="submit" 
                            ...
                            class="w-full flex justify-center py-2 sm:py-3 lg:py-4 px-4 border border-transparent text-xs sm:text-sm lg:text-base font-medium rounded-lg text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">
                        <template x-if="!loading">
                            <span><i class="fas fa-shield-alt mr-2"></i> Administrator Login</span>
                        </template>
                        <template x-if="loading">
            ...
            <!-- Administrator Role Badges -->
            <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                <div class="flex flex-wrap items-center justify-center gap-1 sm:gap-2">
                    <span class="inline-flex items-center px-1.5 sm:px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                        <i class="fas fa-user-tie mr-1"></i>
                        HR
                    </span>
                    <span class="inline-flex items-center px-1.5 sm:px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        <i class="fas fa-users mr-1"></i>
                        HOD
                    </span>
                    <span class="inline-flex items-center px-1.5 sm:px-2 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
        ...
        <div class="mt-4 sm:mt-6 text-center">
            <p class="text-xs sm:text-sm text-gray-600">
                Are you an employee? 
                <a href="{{ route('employee.login') }}" class="text-green-600 hover:text-green-500 font-medium transition-colors duration-200">
